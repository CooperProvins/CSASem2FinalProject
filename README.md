...
Or alternatively, we can calculate our z score with the relevant formula and convert it into a percentile with the implementation of pre-written methods, beyond my scope to explain.<br>
## Credits
